(function (global) {
	...
	try {
		...
		palms.exported.framework.PalmsUIApplication.addRoleScreen("receipts\\jsPlugIn\\materialProcurement".toLowerCase(), "TPS");
		palms.exported.framework.PalmsUIApplication.addRoleScreen("receipts\\jsPlugIn\\materialProcurement".toLowerCase(), "SSPCS");
