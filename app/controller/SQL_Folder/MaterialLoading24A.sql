...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ViewScreenMapping]
               ...
               WHERE [ViewName] = 'SSPCSCustomReports.v_MaterialLoadingView24A')
...
BEGIN
    ...
    ('SSPCSCustomReports.v_MaterialLoadingView24A', 1, GETDATE(), 440, NULL, 'MaterialLoadingView24A');
 
END;

DROP VIEW [SSPCSCustomReports].[v_MaterialLoadingView24A]
GO
...
CREATE VIEW [SSPCSCustomReports].[v_MaterialLoadingView24A] AS
...
WHERE 
   SSPCSdbo.PatternActualData.LineID = 2
GROUP BY
